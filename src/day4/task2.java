...
public class task2 {
    public static void main(String[] args) {
        String[] words = Text.TEXT.toLowerCase().split("\\s+"); //toLowerCase -to ignore case sensitivity
        Set<String> wordsSet = new HashSet<>();  //new Set
        wordsSet.addAll(List.of(words));         //add text
